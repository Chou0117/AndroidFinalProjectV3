...
public class ActivityDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE="CREATE TABLE "+ TABLE_NAME + " ( " + PRIMARY_KEY + " INTEGER PRIMARY KEY AUTOINCREMENT, " + ACTIVITY_TYPE + " TEXT NOT NULL, " + ACTIVITY_TIME + " INTEGER NOT NULL, " + ACTIVITY_COMMENTS + " TEXT, " + ACTIVITY_TIMESTAMP + " DATETIME DEFAULT CURRENT_TIMESTAMP);";
